...
# 5. Optional: Scatterplot mit Regressionslinie (nur wenn 1 Feature visualisiert werden soll)
# >>> Nur aktivieren, wenn du EIN Prinzip gezielt untersuchen willst <<<

feature = prinzipien_daten.iloc[:, 0]  # z.B. erstes Prinzip
plt.figure(figsize=(8, 5))
...
feature = prinzipien_daten.iloc[:, 1]  # z.B. erstes Prinzip
plt.figure(figsize=(8, 5))
sns.regplot(x=feature, y=kompromittier_rate, line_kws={"color": "red"})
...
feature = prinzipien_daten.iloc[:, 2]  # z.B. erstes Prinzip
plt.figure(figsize=(8, 5))
sns.regplot(x=feature, y=kompromittier_rate, line_kws={"color": "red"})
...
feature = prinzipien_daten.iloc[:, 3]  # z.B. erstes Prinzip
plt.figure(figsize=(8, 5))
sns.regplot(x=feature, y=kompromittier_rate, line_kws={"color": "red"})
...
feature = prinzipien_daten.iloc[:, 4]  # z.B. erstes Prinzip
plt.figure(figsize=(8, 5))
sns.regplot(x=feature, y=kompromittier_rate, line_kws={"color": "red"})
...
feature = prinzipien_daten.iloc[:, 5]  # z.B. erstes Prinzip
plt.figure(figsize=(8, 5))
sns.regplot(x=feature, y=kompromittier_rate, line_kws={"color": "red"})
